...
func main() {
	...
	flag.StringVar(&cfg.serviceAddr, "service-addr", "localhost:7070", "users service address")
	...
	flag.StringVar(&cfg.jwtSecret, "jwt-secret", "lasdjasbdkjasdbajk", "secret to jwt")
	flag.Parse()
	...
	service := NewService(store, cfg.jwtSecret)
